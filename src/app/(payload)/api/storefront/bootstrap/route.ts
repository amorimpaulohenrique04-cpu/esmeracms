 ...
 *
 * Single public bootstrap for the storefront shell + Home. Keep full Payload
 * relationship documents here because media URL fields are derived from
 * metadata such as filename/sizes. Aggressive select/populate projections can
 * turn otherwise valid media URLs into null and break the storefront.
 */
export async function GET(request: Request) {
  try {
    ...
    console.error({
      event: 'storefront.bootstrap.v3.failed',
